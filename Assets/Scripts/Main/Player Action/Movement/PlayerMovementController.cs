...
public class PlayerMovementController : MonoBehaviour
{
    ...
    private void SetPlatformParentPosition()
    {
        ...
        if (curPlatform.TryGetComponent(out IsSplitedMovingPlatform split))
        {
            platformTransform = split.otherSideObject.transform;
        }
        else
        {
            platformTransform = curPlatform.transform;
        }
        platformParent.position = platformTransform.position;
    }
    #endregion
}